...
export function FloatingContactButtons() {
  ...
  return (
    <div
      className="fixed bottom-24 right-4 z-50 pb-safe md:hidden"
    ...
    >
      <div className="flex flex-col items-end gap-3">
        <a
          ...
          aria-label={t("call")}
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#2563EB] text-white shadow-xl transition-all duration-300 hover:scale-105 motion-safe:animate-[floaty_2.5s_ease-in-out_infinite]"
        >
        ...
        <a
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-all duration-300 hover:scale-105 motion-safe:animate-[floaty_2.5s_ease-in-out_infinite]"
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
